...
ActiveRecord::Schema.define(version: 20130908051316) do
  ...
  add_index "discoveries", ["slug"], name: "index_discoveries_on_slug", unique: true, using: :btree
  add_index "discoveries", ["views"], name: "index_discoveries_on_views", using: :btree
